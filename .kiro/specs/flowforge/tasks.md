...
- [ ] 2. Implement workflow data models and serialization
  - [ ] 2.1 Create Workflow, WorkflowNode, Connection, and Position records
    - Implement JSON serialization attributes
    - Add validation annotations
    - _Requirements: 1.1, 1.3_

  - [ ]* 2.2 Write property test for workflow round-trip serialization
    - **Property 1: Workflow Serialization Round-Trip**
    - **Validates: Requirements 1.1, 1.6, 1.7**

  - [ ] 2.3 Implement WorkflowValidator for schema validation
    - Validate required fields, node references, connection validity
    - Return descriptive ValidationError objects
    - _Requirements: 1.4, 1.5_

  - [ ]* 2.4 Write property test for workflow validation
...
- [ ] 8. Implement execution persistence
  ...
  - [ ]* 8.4 Write property test for execution persistence
    - **Property 9: Execution State Persistence**
    - **Validates: Requirements 3.6, 7.1, 7.4**

  - [ ]* 8.5 Write property test for execution filtering
...
- [ ] 13. Implement authentication and authorization
  - [ ] 13.1 Create User and ApiKey models
    - Define UserRole enum
    - _Requirements: 9.1, 9.6_

  - [ ] 13.2 Implement JWT authentication
    - Token generation and validation
    - Support for local accounts
    - _Requirements: 9.1, 8.5_

  - [ ] 13.3 Implement API key authentication
...
- [ ] 16. Implement Blazor designer foundation
  - [ ] 16.1 Create Blazor WebAssembly project structure
    - Set up routing and layout
    - Configure API client
    - _Requirements: 4.1_

  - [ ] 16.2 Implement workflow canvas component
    - SVG-based canvas for node placement
    - Pan and zoom support
    - _Requirements: 4.1_

  - [ ] 16.3 Implement node palette component
    - Display available nodes by category
    - Support drag-and-drop to canvas
    - _Requirements: 4.2_

  - [ ] 16.4 Implement connection drawing
    - Draw connections between node ports
    - Validate port compatibility
    - _Requirements: 4.3_

  - [ ]* 16.5 Write property test for connection validation
    - **Property 10: Connection Port Compatibility**
    - **Validates: Requirements 4.3**

  - [ ] 16.6 Implement node configuration panel
    - Display configuration form for selected node
    - Support expression input fields
    - _Requirements: 4.7_

- [ ] 17. Implement designer state management
  - [ ] 17.1 Create workflow state service
    - Track canvas state (nodes, connections, selection)
    - Serialize to workflow JSON
    - _Requirements: 4.5_

  - [ ] 17.2 Implement undo/redo system
