...
namespace FlowForge.Tests.Integration.ApiKeys;

/// <summary>
/// Integration tests for API key authentication.
/// Tests valid, invalid, expired, and revoked API key scenarios.
/// </summary>
public class ApiKeyAuthenticationTests : IClassFixture<FlowForgeApiFixture>, IAsyncLifetime
{
    private readonly FlowForgeApiFixture _fixture;

    public ApiKeyAuthenticationTests(FlowForgeApiFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task WhenExpiredApiKeyThenReturns401Unauthorized()
    {
        ...
        var user = await userRepository.GetByEmailAsync(FlowForgeApiFixture.TestUsers.Editor.Email);
        Assert.NotNull(user);
