...
namespace Vyshyvanka.Tests.Integration.Designer.Generators;
...
public static class DesignerGenerators
{
    ...
    public static readonly Gen<Vyshyvanka.Designer.Models.ToastType> ToastTypeGen =
        Gen.OneOf(
            Gen.Const(Vyshyvanka.Designer.Models.ToastType.Success),
            Gen.Const(Vyshyvanka.Designer.Models.ToastType.Error),
            Gen.Const(Vyshyvanka.Designer.Models.ToastType.Warning),
            Gen.Const(Vyshyvanka.Designer.Models.ToastType.Info)
        );
