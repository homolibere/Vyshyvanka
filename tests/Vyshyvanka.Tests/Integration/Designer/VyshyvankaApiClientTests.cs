...
public class VyshyvankaApiClientTests
{
    ...
    private static VyshyvankaApiClient CreateClient(MockHttpMessageHandler handler)
    {
        var httpClient = new HttpClient(handler)
        {
            BaseAddress = new Uri("http://test-api/")
        };
        return new VyshyvankaApiClient(httpClient);
    }
    ...
    /// For any valid JSON workflow response from the API, the VyshyvankaApiClient SHALL 
