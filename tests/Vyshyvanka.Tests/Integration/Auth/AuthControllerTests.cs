...
public class AuthControllerTests : IClassFixture<VyshyvankaApiFixture>
{
    ...
    public async Task WhenValidCredentialsThenReturnsAccessToken()
    {
        ...
        {
            Email = VyshyvankaApiFixture.TestUsers.Editor.Email,
            Password = VyshyvankaApiFixture.TestUsers.Editor.Password
        };
        ...
        Assert.Equal(VyshyvankaApiFixture.TestUsers.Editor.Email, loginResponse.User.Email);
    }
