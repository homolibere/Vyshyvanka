...
/// </summary>
internal class CustomWebApplicationFactory : WebApplicationFactory<Vyshyvanka.Api.Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            var dbContextDescriptor = services.SingleOrDefault(
                d => d.ServiceType == typeof(DbContextOptions<VyshyvankaDbContext>));
            ...
            var dbContextServiceDescriptor = services.SingleOrDefault(
                d => d.ServiceType == typeof(VyshyvankaDbContext));
            ...
            {
                SecretKey = "VyshyvankaDefaultSecretKey123456789012345678901234567890",
                Issuer = "Vyshyvanka",
                Audience = "Vyshyvanka",
