...
/// Feature: flowforge, Property 13: Credential Encryption and Non-Exposure
/// </summary>
public class CredentialSecurityTests
{
    ...
    /// <summary>
    /// Feature: flowforge, Property 14: Credential Injection at Runtime
    ...
    public void CredentialInjection_ProvidesDecryptedValuesAtRuntime()
    {
        GenCredentialDataWithType.Sample(testData =>
        {
            ...
            var executionContext = new FlowForge.Engine.Execution.ExecutionContext(
                Guid.NewGuid(),
                Guid.NewGuid(),
                credentialProvider);
