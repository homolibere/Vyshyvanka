...
public class NodeRefreshAfterOperationsTests
{
    ...
    private static readonly Gen<string> GenPackageId =
        Gen.Char['a', 'z'].Array[5, 15].Select(chars => $"FlowForge.Plugin.{new string(chars)}");
    ...
    private static (FlowForgeApiClient ApiClient, WorkflowStateService WorkflowStateService,
