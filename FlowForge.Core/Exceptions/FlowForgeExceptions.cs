namespace FlowForge.Core.Exceptions;

/// <summary>
/// Base exception for FlowForge-specific errors.
/// </summary>
public abstract class FlowForgeException : Exception
{
    /// <summary>Error code for programmatic handling.</summary>
    public string ErrorCode { get; }

    protected FlowForgeException(string errorCode, string message) 
        : base(message)
    {
        ErrorCode = errorCode;
    }

    protected FlowForgeException(string errorCode, string message, Exception innerException) 
...
/// </summary>
public class WorkflowNotFoundException : FlowForgeException
{
...
/// </summary>
public class WorkflowValidationException : FlowForgeException
{
...
/// </summary>
public class ExecutionNotFoundException : FlowForgeException
{
...
/// </summary>
public class WorkflowExecutionException : FlowForgeException
{
    public Guid ExecutionId { get; }
...
/// </summary>
public class CredentialNotFoundException : FlowForgeException
{
...
/// </summary>
public class VersionConflictException : FlowForgeException
{
