...
/// <summary>
/// EF Core database context for Vyshyvanka persistence.
/// </summary>
public class VyshyvankaDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<UserEntity>(entity =>
        {
            ...
            entity.Property(e => e.AuthenticationProvider)
                ...
                .HasMaxLength(50)
                .HasDefaultValue(Vyshyvanka.Core.Enums.AuthenticationProvider.BuiltIn);
