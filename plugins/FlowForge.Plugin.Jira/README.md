# FlowForge.Plugin.Jira

Jira Software integration plugin for [FlowForge](https://github.com/flowforge/flowforge). Manage issues, comments, and users via the Jira Cloud REST API v3.
