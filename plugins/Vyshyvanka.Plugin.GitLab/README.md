...
GitLab integration plugin for [Vyshyvanka](https://github.com/vyshyvanka/vyshyvanka). Manage issues, repository files, releases, and repositories via the GitLab REST API v4.
